...
\begin{DoxyCompactList}\small\item\em The default Lagrangian Particle solver for the compressible Euler's equation. \end{DoxyCompactList}\end{DoxyCompactItemize}
